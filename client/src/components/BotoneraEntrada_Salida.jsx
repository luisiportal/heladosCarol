  ...
  return (
    <div className="flex justify-center">
      <Link to="/movimientos/entrada">
        ...
        <button className=" bg-white border-heladosCarol_color border-l-8  rounded-md p-3 font-bold text-sm uppercase gap-1 shadow-md w-fit m-4 flex justify-center">
          {<ArrowUpSVG/>} Entrada
        </button>
      </Link>
