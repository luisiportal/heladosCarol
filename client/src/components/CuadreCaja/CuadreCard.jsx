...
function CuadreCard({ cuadre }) {
  ...
  return (
    <section className="shadow-md  mt-8 mx-2 grid grid-cols-2 gap-4 bg-white border-l-4 border-heladosCarol_color rounded-xl mb-5 max-w-md">
      <div>
        {/* left*/}
        <div className="flex gap-1 bg-heladosCarol_color rounded-br-xl rounded-tl-lg p-2 text-white font-bold">
      ...
      <div className=" flex flex-col text-xs border-l-2 border-slate-200 font-semibold">
        ...
        <div className="flex flex-1 bg-heladosCarol_color rounded-br-xl rounded-tl-lg p-2  text-white justify-center font-bold text-base bottom-0">
