...
const TinaCardElement = ({ tina }) => {
  ...
  return (
    <div
      ...
      className="flex flex-col justify-center items-center font-irish text-md text-center rounded-lg p-2 w-24 h-16 overflow-hidden"
    >
      <div className="">
        {" "}
        ...
        <div className="opacity-0 -translate-y-3 aparecer transition-all duration-700">
