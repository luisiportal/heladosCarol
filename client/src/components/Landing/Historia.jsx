  ...
  return (
    <LayoutPrincipal>
      <div>
        ...
        <p>
          {" "}
          El <strong>11 de enero del 2020</strong> se realiza en nuestra familia
          la primera producción de helados, un momento lleno de emociones y
          esperanzas.
        </p>
        <p>
          {" "}
        ...
        <img
          className="justify-center rounded-xl object-cover object-center my-2 shadow-md"
          src="/images/lacream.jpeg"
          alt="Historia Helados Carol"
        />
        <p>
          {" "}
        ...
        <p>
          ...
          <strong> Helados Carol</strong>, bujía inspiradora que hace posible
          trabajar constantemente pensando en la mejora y la satisfacción de
          nuestros clientes, a los cuales agradecemos por su confianza y por ser
          parte de la familia de Helados Carol.
        </p>
      </div>
    </LayoutPrincipal>
  );
