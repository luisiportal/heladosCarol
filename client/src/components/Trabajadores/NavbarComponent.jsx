...
const NavbarComponent = () => {
  ...
  const { isAuthenticated, heladosCarol_colorut, user, perfil, isOnline, setIsOnline } =
    useAuth();
      ...
      <header className="fixed w-full bg-heladosCarol_color px-6 z-50 rounded shadow-xl">
        <div className="flex justify-between h-16 items-center max-w-7xl mx-auto">
          <div className="flex -mr-4">
            ...
            <div>
              <Link
                className="text-heladosCarol_color hover:rotate-6 duration-200"
                to={"/"}
              >
                <img
                  className="w-52 h-12"
