      ...
      <header className="bg-white shadow px-6">
        ...
        <div className="flex justify-between h-16 items-center max-w-3xl mx-auto">
          ...
          <div className="flex -mr-4">
            <div>
              <a
                className="text-heladosCarol_color hover:rotate-6 duration-200 m"
                href="#"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="hidden md:flex space-x-8 ml-8">
              <a
                href="#"
                className=" block bg-heladosCarol_color text-white px-3 py-2 rounded-md transition-colors"
              >
                Inicio
              </a>
              <a
                href="#"
                className=" block text-slate-700 hover:bg-heladosCarol_color hover:text-white px-3 py-2 rounded-md transition-colors"
              >
                Movimientos
              </a>
              <a
